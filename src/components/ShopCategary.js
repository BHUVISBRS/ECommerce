  ...
  return (
    <>
                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    <Typography
                      ...
                      variant="h5"
                      component="div"
                      sx={{ marginLeft: 2, letterSpacing: 1 }}
                    >
                      Everyday Shoes
                    </Typography>
                    ...
                    <Typography
                      ...
                      sx={{ marginLeft: 2 }}
                    >
                      <img src="TREE.png" alt="#" style={{ height: 35 }} />
                      Comfy, All-Day Wearable
                    </Typography>
                  </CardContent>
                </CardActionArea>
              </Card>
                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    <Typography
                      ...
                      sx={{ marginLeft: 2 }}
                    >
                      <img src="TREE.png" alt="logo" style={{ height: 35 }} />
                      Easy on, Easy off
                    </Typography>
                  </CardContent>
                </CardActionArea>
      ...
      <div>
        <Typography
          variant="h4"
          sx={{ marginLeft: 65, paddingTop: 14, paddingBottom: 2 }}
        >
          Summer Styles
        </Typography>
        <Typography sx={{ marginLeft: 45, paddingBottom: 7, color: "grey" }}>
          Get a move on (or out) in bouncy shoes made with natural materials.
        </Typography>
        <div style={{ bgcolor: "black", marginLeft: 450 }}>
